public class App {
    public static void main(String[] args) throws Exception {
      /*Escopo
       * O escopo pode ser entendido como o ambiente onde uma váriavel pode ser acessada. Em Java, o escopo de variáveis vai de acordo com o bloco onde ela foi declarada.
       * --------------------------------------------
